    ...
    <div class="mt-10 grid grid-cols-3 gap-6 lg:mt-16 lg:grid-cols-4 lg:gap-4">
      ...
      <article class="relative">
        <div class="aspect-square overflow-hidden">
          <img class="group-hover:scale-125 h-full w-full object-cover transition-all duration-300" src="https://pbs.twimg.com/profile_images/1544317667565355010/UFbKxJKm_400x400.jpg" alt="" />
        </div>
